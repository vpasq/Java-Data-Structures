...
//            data[i] = data[i+1];
   ...
   **/
  public static DoubleArraySeq concatenate(DoubleArraySeq sequence1, DoubleArraySeq sequence2) {
    ...
    DoubleArraySeq newSequence = new DoubleArraySeq(length);
  ...
  public boolean equals(Object obj) {
    ...
    if (this.getClass() == obj.getClass()) {
      DoubleArraySeq other = (DoubleArraySeq) obj;
